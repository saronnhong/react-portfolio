                    ...
                    <div  className="wrapper animated bounceInLeft">
                        <div className="company-info">
                            ...
                            <ul className="ulForm">
                                ...
                                <a className="contactLinks" href="https://www.linkedin.com/in/saronnhong"><h6><i class="fab fa-linkedin"></i> LinkedIn</h6></a>
                                <a className="contactLinks" href="https://github.com/saronnhong"><h6><i class="fab fa-github"></i> Github</h6></a>
                            </ul>
                        </div>
